...
int GuiMain(drawcallback drawfunction, void* obj_ptr)
{
    ...
    //std::string imagePath = "C:/Users\samir\Downloads\Final Project\photo_2024 - 08 - 28_20 - 39 - 35.png";
    ID3D11ShaderResourceView* my_texture = nullptr;
    int my_image_width = 0;
    int my_image_height = 0;
    bool ret = LoadTextureFromFile("C:/Users/samir/Downloads/Final Project/photo_2024 - 08 - 28_20 - 39 - 35.png", &my_texture, &my_image_width, &my_image_height);
    if (!ret) {
